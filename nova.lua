...
MM2:CreateButton({Name = "VexonHub", Callback = function() safeLoad("https://raw.githubusercontent.com/DiosDi/VexonHub/refs/heads/main/VexonHub") end})
MM2:CreateButton({Name = "Horizon Hub", Callback = function() safeLoad("https://pastefy.app/wwfom1bX/raw") end })
MM2:CreateButton({Name = "Overdrive-H", Callback = function () safeLoad("https://raw.githubusercontent.com/Aghm99/FREE-KEYLESS/refs/heads/main/Overdrive-H/MurderMystery2.lua") end})